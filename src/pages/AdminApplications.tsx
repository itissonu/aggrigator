...
import { mockApplications, type LicenseApplication, type ApplicationStatus } from '@/lib/mockData';
...
export default function AdminApplications() {
  const [applications, setApplications] = useState<LicenseApplication[]>(mockApplications);
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Badge className={cn("text-[10px] font-bold border", statusColors[app.status])}>{app.status}</Badge>
