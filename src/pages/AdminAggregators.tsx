...
import { mockCompanies, formatINR } from '@/lib/mockData';
    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="glass rounded-xl p-4 cursor-pointer hover:shadow-md transition-shadow" onClick={() => setFilterType('All')}>
          ...
          <p className="text-2xl font-heading font-bold mt-1">{mockCompanies.length}</p>
        </div>
        <div className="glass rounded-xl p-4 cursor-pointer hover:shadow-md transition-shadow" onClick={() => setFilterType('Aggregator')}>
          ...
          <p className="text-2xl font-heading font-bold mt-1 text-blue-600">{mockCompanies.filter(c => c.type === 'Aggregator').length}</p>
        </div>
        <div className="glass rounded-xl p-4 cursor-pointer hover:shadow-md transition-shadow" onClick={() => setFilterType('DSP')}>
          ...
          <p className="text-2xl font-heading font-bold mt-1 text-purple-600">{mockCompanies.filter(c => c.type === 'DSP').length}</p>
        </div>
      </div>
