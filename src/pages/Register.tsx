...
import { Leaf, Building2, FileUp, Truck, ClipboardCheck, ArrowLeft, ArrowRight, Check, Zap, Upload, AlertCircle } from 'lucide-react';
        ...
        <div className="flex-1 flex flex-col px-6 py-8 md:px-16 md:py-12 max-w-3xl w-full mx-auto">
          ...
          <div className="pt-6 mt-auto flex items-center justify-between border-t border-border">
            ...
            {step < 3 ? (
              ...
              <Button variant="accent" onClick={handleSubmit} disabled={!agreed} className="gap-2 px-8">
                <ClipboardCheck className="h-4 w-4" /> Submit to Govt.
              </Button>
            )}
          </div>
        </div>
